...
from config.datas import TOTAL_DESM_21_ANOS, DT_LAST_YEAR, DT_FIRST_YEAR, DEFAULT_MUN_IBGE, DEFAULT_STAT_NAME, DEFAULT_STAT, DEFAULT_MUN, ESTADOS
from config.definitions import LABEL_FONT_SIZE, LABEL_CARD_SIZE, ANO_INI, ANO_FIM
